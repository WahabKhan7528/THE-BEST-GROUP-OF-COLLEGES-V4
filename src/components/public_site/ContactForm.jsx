...
const ContactForm = () => {
  ...
  return (
    <Card shadow="xl" className="p-6 md:p-10 border-t-4 border-t-college-gold rounded-2xl bg-white">
      ...
      <form ref={formRef} onSubmit={handleContactSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label
              htmlFor="name"
              className="block text-sm font-bold text-college-navy mb-2 tracking-wide"
            >
              Full Name *
            </label>
            <input
        ...
        <PublicButton
          ...
          variant="primary"
          size="lg"
          className="w-full transition-all shadow-md uppercase tracking-wider"
          icon={Send}
        >
