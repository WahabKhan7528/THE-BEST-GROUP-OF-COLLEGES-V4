    ...
    <div className="min-h-screen bg-white font-sans overflow-x-hidden">
      ...
      <Section spacing="standard" background="white" className="relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="mb-4">
              <Badge variant="soft" className="px-4 py-2">Legal Excellence</Badge>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Training the next generation of legal professionals with a focus on ethical practice.",
                },
                {
                  title: "Clinical Education",
                  desc: "Hands-on experience through moot courts and legal aid clinics.",
                },
              ].map((item) => (
          ...
          <div className="relative">
            ...
            <Card className="relative border border-gray-100 shadow-2xl bg-white/95 backdrop-blur-md rounded-2xl p-8 md:p-10 overflow-hidden group">
              <div className="relative z-10">
                <div className="mb-6">
                  <Badge variant="solid" className="bg-college-navy text-college-gold px-4 py-1.5">Our Mission</Badge>
                </div>
      ...
      <Section background="navy" spacing="small" className="relative py-16 md:py-20 flex items-center justify-center text-center">
        <div className="absolute inset-0 opacity-10">
          <img src="/lawcampus.webp" className="w-full h-full object-cover filter grayscale" />
        </div>
        <div className="absolute inset-0 bg-college-navy/80 backdrop-blur-[2px]" />

        <div className="relative z-10 max-w-4xl mx-auto px-6">
          <Badge variant="soft" className="mb-6 px-5 py-1.5">ADMISSIONS IN PROGRESS</Badge>
