    ...
    <div className="min-h-screen bg-white font-sans overflow-x-hidden">
      ...
      <Section spacing="standard" background="white" className="relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="mb-4">
              <Badge variant="soft" className="px-4 py-2">Our Foundation</Badge>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Rigorous curriculum paired with innovative research initiatives.",
                },
                {
                  title: "Innovation Hub",
                  desc: "Fostering a culture of discovery and creative problem solving.",
                },
              ].map((item) => (
      ...
      <Section background="navy" spacing="small" className="relative py-16 md:py-20 flex items-center justify-center text-center">
        <div className="absolute inset-0 opacity-10">
          <img src="/maincampus.webp" className="w-full h-full object-cover filter grayscale" />
        </div>
        <div className="absolute inset-0 bg-college-navy/80 backdrop-blur-[2px]" />

        <div className="relative z-10 max-w-4xl mx-auto px-6">
          <Badge variant="soft" className="mb-6 px-5 py-1.5">ADMISSIONS OPEN 2024</Badge>
          ...
          <p className="text-lg md:text-xl text-white/70 mb-8 leading-relaxed max-w-2xl mx-auto font-sans">
            Don't just witness history, create it. Join a community of innovators
            redefining the educational landscape of Pakistan.
          </p>
