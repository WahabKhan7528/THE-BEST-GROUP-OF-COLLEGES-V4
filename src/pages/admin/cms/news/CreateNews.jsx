      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <PortalForms.Section className="!p-6">
            <h2 className="text-sm font-bold text-college-navy dark:text-college-gold uppercase tracking-wider mb-4 col-span-1 md:col-span-2">Content Type</h2>
        ...
        <div className="space-y-6">
          ...
          <PortalForms.Section className="!p-6 !flex !flex-col !gap-4">
            <h3 className="text-sm font-semibold text-college-navy dark:text-college-gold uppercase tracking-wider !col-span-1 border-none pb-0">Publishing</h3>
          ...
          {/* Image Upload */}
          <PortalForms.Section className="!p-6 !flex !flex-col !gap-4">
            <h3 className="text-sm font-semibold text-college-navy dark:text-college-gold uppercase tracking-wider !col-span-1 border-none pb-0">Featured Image</h3>
