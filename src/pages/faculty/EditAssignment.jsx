        ...
        >
            <div className="flex items-center gap-4">
                <Link
                    ...
                    className="p-2.5 rounded-xl bg-white/50 hover:bg-white text-gray-500 hover:text-college-navy border border-transparent hover:border-gray-200 transition-all duration-200"
                >
                    <ArrowLeft size={20} />
                </Link>
                <div>
                    <h1 className="text-2xl font-bold text-college-navy">Edit Assignment</h1>
