      ...
      <div className="bg-white border rounded-xl md:rounded-2xl shadow-sm p-4 md:p-5">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 md:gap-4">
          ...
          <button
            ...
            className="px-4 py-2 bg-college-navy hover:bg-college-navy/90 text-white rounded-lg text-sm font-semibold shadow-md"
          >
            Save marks
          </button>
        </div>
      ...
      {classes.length > 0 ? (
        <div className="bg-white border rounded-2xl shadow-sm p-6 space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-lg font-bold text-college-navy">
                Select Course & Class
              </h2>
            ...
            {classes.map((cls) => (
              ...
              >
                <div className="relative z-10">
                  ...
                  <h3 className="text-base font-bold text-college-navy mb-1 group-hover:text-blue-700 transition-colors">
                    {cls.name}
                  </h3>
                  ...
                  <div className="flex items-center justify-between mt-3 pt-3 border-t border-gray-100 group-hover:border-blue-100">
                    ...
                    <div className="text-right">
                      <span className="block text-lg font-bold text-college-navy leading-none">{cls.students}</span>
      ...
      {selectedClass && selectedStudents.length > 0 && (
        <>
          <div className="bg-white border rounded-2xl shadow-sm p-6 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-college-navy/10/50 rounded-bl-full -mr-8 -mt-8"></div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-college-navy">{selectedClass.name}</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-college-navy">Section {selectedClass.section}</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-college-navy">{totalStudents} Students</p>
                ...
                <div className="pl-4 md:border-l border-gray-100 flex flex-col justify-center">
                  ...
                  <p className="text-2xl font-bold text-college-navy">{averageMarks}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border rounded-2xl shadow-sm p-5">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-college-navy">
                Student Marks
              </h3>
